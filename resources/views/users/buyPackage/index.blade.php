                ...
                <div class="tz-2-com tz-2-main">
                    ...
                    <div class="db-list-com tz-db-table">
                        <div class="ds-boar-title">
                            <h2>Package Transaction History</h2>
                            <p>All your package transaction history purchased overtime</p>
                        </div>
                        <table id="" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$h->amount}}SKC</td>
                                    <td>{{$h->status}} </td>
                                    <td><a href="{{route('account.buy.package.show', $h->identifier)}}" class="db-list-edit">View</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
