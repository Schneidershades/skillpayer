                ...
                <div class="tz-2-com tz-2-main">
                    ...
                    <div class="db-list-com tz-db-table">
                        <div class="ds-boar-title">
                            <h2>Power Transaction History</h2>
                            <p>All your power transaction history overtime</p>
                        </div>
                        <table id="footer-search" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$h->commission_applied}}</td>
                                    <td>{{$h->user->username}}</td>
                                    <td>{{$h->phone}}</td>

                                    <td>{{$h->api_used}} </td>
                                    <td>{{$h->api_reference}} </td>
                                    <td>{{$h->api_response}} </td>
                                    <td>{{$h->api_product_reference}} </td>
                                    <td>{{$h->status}} </td>
                                    <td>{{$h->balance}}</td>
                                    <td><a class="btn btn-primary"  href="{{route('admin.power.details', $h->identifier)}}">View Transaction</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
