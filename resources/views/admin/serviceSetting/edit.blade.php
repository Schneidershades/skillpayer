    ...
    <div class="tz">
      ...
      <div class="tz-2">
        <div class="tz-2-com tz-2-main">
          <h4>Service Setting Profile</h4>
          <div class="db-list-com tz-db-table">
            <div class="ds-boar-title">
              <h2>Edit Service Profile {{$service->title}} - {{$service->type}}</h2>
              <p>You can edit your service profile for {{$service->title}} - {{$service->type}} here</p>

              @include('partials._errors')
            </div>
            <div class="tz2-form-pay tz2-form-com">
              <form action="{{route('admin.service-setting.update', [$service->id] )}}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-4">
